...
import (
	...
	scheme "github.com/comavius/kinugasa-recording/api/generated/clientset/versioned/scheme"
...
func newSessions(c *RecordingV1alpha1Client, namespace string) *sessions {
	return &sessions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *sessions) UpdateStatus(ctx context.Context, session *v1alpha1.Session, opts v1.UpdateOptions) (result *v1alpha1.Session, err error) {
	result = &v1alpha1.Session{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sessions").
