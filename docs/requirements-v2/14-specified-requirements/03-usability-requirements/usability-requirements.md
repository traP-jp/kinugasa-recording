...
- 前項の警告では、影響を受けるVideoFileを表示し、ユーザーが`I_do_understand_the_danger_of_data_inconsistency_and_really_want_to_delete_this_camera`と入力した場合に限り強制削除を実行できる。文字列の比較は大文字と小文字を区別した完全一致とする。
